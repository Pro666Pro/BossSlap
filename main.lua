...
local Window = OrionLib:MakeWindow({IntroText = "farm slap safely lol", IntroIcon = "rbxassetid://15315284749",Name = GameName, HidePremium = false, SaveConfig = true, ConfigFolder = "Tutorial"})
